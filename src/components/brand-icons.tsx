...
/**
 * Brand glyphs (GitHub, LinkedIn). lucide-react v1 removed brand/logo icons,
 * so these are provided as small inline SVGs that accept standard SVG props
 * (className, etc.) and inherit `currentColor`.
 */
